...
function CreateLabelsAndButtons()
{
    ...
    let startButton = new PIXI.Text("Enter, ... if you date!");
    ...
    finalScoreText = new PIXI.Text("");
    finalScoreText.style = textStyle;
    finalScoreText.x = 100;
    finalScoreText.y = sceneHeight/2 + 100;
